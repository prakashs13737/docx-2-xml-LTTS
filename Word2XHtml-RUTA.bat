...
java -cp %CP% net.sf.saxon.Transform -t -o:"%%~nf-out2.xml" "%%~nf.xml" "01-W2H.xslt"
...
java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out4.xml" "%%~nf-out3.xml" "1-LIST.xslt"
java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out5.xml" "%%~nf-out4.xml" "2-LIST.xslt"
java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out6.xml" "%%~nf-out5.xml" "3-LIST.xslt"
java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out7.xml" "%%~nf-out6.xml" "35-LIST.xslt"
java -cp %CP% net.sf.saxon.Transform -o:"%%~nf-out8.xml" "%%~nf-out7.xml" "4-LIST.xslt"
cls
echo list converted
pause

java -cp %CP% net.sf.saxon.Transform -o:"%%~nf.xhtml" "%%~nf-out8.xml" "03-Final-Ruta.xslt"
